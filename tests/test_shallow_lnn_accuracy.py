...
class ShallowLinearNN(nn.Module):
...
def main():
    ...
    parser.add_argument(
        "--model-path",
        type=str,
        default="notebooks/models/shallow_lnn_best.pth",
    ...
    model = ShallowLinearNN(num_classes=num_classes, image_size=(args.image_size, args.image_size))
