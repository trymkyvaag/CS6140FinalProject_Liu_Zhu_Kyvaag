#!/usr/bin/env python3
"""
Evaluate the shallow CNN saved weights on a test dataset and print accuracy.

Usage:
  python tests/test_shallow_nn_accuracy.py --test-dir <path> --model-path <path>
...
def main():
    ...
    parser.add_argument(
        "--model-path",
        type=str,
        default="notebooks/models/shallow_nn_best.pth",
